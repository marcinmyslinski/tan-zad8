...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        public static bool Task8()
        {
            ...
            //  if ( Emps.Where(e => e.Job == "Backend programmer") != null)
        ...
        {
            Emp result = Emps.First(e=> e.Job == "Frontend programmer");
            return result;
        }
        ...
        {
            var myAnonymousType = new { Ename = "Brak wartości", Job = (string?)null , Hiredate = (string?)null };



            IEnumerable<object> result = (from e in Emps
                                          select new { Ename = e.Ename, Job = e.Job, Hiredate = e.HireDate });//.Union(myAnonymousType).ToList();
            return result;
        }
                                         //from e in Emps
                                         //select new { Nazwisko = e.Ename, Praca = e.Job
